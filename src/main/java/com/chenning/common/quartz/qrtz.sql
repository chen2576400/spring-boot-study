...
-- Records of card
-- ----------------------------
INSERT INTO `card` VALUES (1, 1, '420123456');
INSERT INTO `card` VALUES (2, 2, '4205555');
...
CREATE TABLE `qrtz_schedule_job`  (
  ...
  `bean_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `method_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  UNIQUE INDEX `pk_job_id`(`job_id`) USING BTREE
...
CREATE TABLE `qrtz_schedule_job_log`  (
  ...
  `bean_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `method_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `params` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `status` smallint(0) NULL DEFAULT NULL,
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `times` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `pk_qrtz_schedule_job_log_id`(`id`) USING BTREE,
  INDEX `ix_qrtz_schedule_job_log_job_id`(`job_id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '123456', '张三', '湖北省十堰市');
INSERT INTO `user` VALUES (2, '123456', '李四', '湖北省武汉市');
