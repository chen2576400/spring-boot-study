...
public class RedisService {
    ...
    public  Boolean setIfAbsent(Object k,Object v,final long time){
      return   redisTemplate.opsForValue().setIfAbsent(k,v,time,TimeUnit.SECONDS);
    }
