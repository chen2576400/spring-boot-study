package com.chengning.point;

import com.chengning.model.MethodLock;
import com.chengning.repository.MethodLockRepository;
 ...
 * 实现的原理是 数据库主键ID是唯一的  如果很多主键相同的请求每次肯定只有一条数据插入  执行完后再删除  以此类推达到分布式锁的目的
 */
@Aspect
@Configuration
public class TaskPointcut {
     ...
     */
    @Pointcut("execution(public * com.chengning.controller.OrderController.*(..)))")
